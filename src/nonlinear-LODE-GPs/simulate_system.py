...
A, _ = system.get_ODEmatrix(u_r_rel)
x_r = np.array(system.equilibrium)
x0 = np.copy(x_r)
#x0[3] = u_rel * system.param.u
sol = solve_ivp(system.stateTransition, [tStart, tEnd], x0, method='RK45', t_eval=ts, args = (u_rel * system.param.u,))#, max_step=dt ,  atol = 1, rtol = 1
