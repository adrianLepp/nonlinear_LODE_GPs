...
class LODE_Kernel_2(Kernel):
        def __init__(self, A, common_terms, active_dims=None):
            super(LODE_Kernel_2, self).__init__(active_dims=active_dims)
            ...
            variables = var(["x", "dx1", "dx2"] + ["t1", "t2"] + [f"LODEGP_kernel_{i}" for i in range(len(kernel_matrix[Integer(0)]))])
...
#-----------------------------------------------
# Ab hier ist der Code nicht relevant (alte Version)
#-----------------------------------------------
